...
public class sbst50SJTest {
    ...
    @Test
    public void testArrowBackNotNull() {
      WebDriver driver = new EdgeDriver();
      ArrowBack arrowBack = new ArrowBack(driver);
      Assert.assertNotNull(arrowBack, "Assertion failed: arrowBack object is null");
      System.out.println("1");
    }
    
    @Test
    public void testCrossBackNotNull() {
      WebDriver driver = new EdgeDriver();
      CrossBack crossBack = new CrossBack(driver);
      Assert.assertNotNull(crossBack, "Assertion failed: crossBack object is null");
...
class CARSORTAXIS {
	...
	public CARSORTAXIS(WebDriver driver) {
		this.element = driver.findElement(By.xpath("//button[contains(text(),'CARS OR TAXIS')]"));
	}
...
class PUBLICBUSES {
	...
	public PUBLICBUSES(WebDriver driver) {
		this.element = driver.findElement(By.xpath("//button[contains(text(),'PUBLIC BUSES')]"));
	}
